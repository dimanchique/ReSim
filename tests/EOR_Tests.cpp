...
public:
    void EOR_IM_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::EOR_IM;
    ...
    void EOR_ZP_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::EOR_ZP;
        mem[0xFFFD] = 0x42;
    ...
    void EOR_ZPX_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        ...
        cpu.A = initialValue;
        cpu.X = 0x10;
        mem[0xFFFC] = CPU6502_OpCodes::EOR_ZPX;
        mem[0xFFFD] = 0x42;
    ...
    void EOR_ABS_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::EOR_ABS;
        mem[0xFFFD] = 0x80;
        mem[0xFFFE] = 0x44;
...
TEST_F(CPU6502_EORFixture, EOR_INDY_CanLoadValue_WithExtraCycleOnPageCrossing) {
    // given:
    cpu.A = 0x42;
