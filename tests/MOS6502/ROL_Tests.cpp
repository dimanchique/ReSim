...
public:
    void ROL_ACC_CanRollLeft(BYTE value) {
        // given:
        cpu.A = value;
        mem[0xFFFC] = MOS6502_OpCodes::ROL_ACC;
    ...
    void ROL_ZP_CanRollLeft(BYTE value) {
        // given:
        mem[0xFFFC] = MOS6502_OpCodes::ROL_ZP;
        mem[0xFFFD] = 0x42;
        mem[0x0042] = value;
    ...
    void ROL_ZPX_CanRollLeft(BYTE value) {
        // given:
        cpu.X = 0x10;
        mem[0xFFFC] = MOS6502_OpCodes::ROL_ZPX;
        mem[0xFFFD] = 0x42;
    ...
    void ROL_ABS_CanRollLeft(BYTE value) {
        // given:
        mem[0xFFFC] = MOS6502_OpCodes::ROL_ABS;
        mem[0xFFFD] = 0x01;
        mem[0xFFFE] = 0x44;
        mem[0x4401] = value;
...
TEST_F(MOS6502_ROLFixture, ROL_ABSX_CanRollLeft) {
    cpu.Status.C = 1;
    cpu.X = 0x05;
    ROL_ABS_CanRollLeft(MOS6502_OpCodes::ROL_ABSX, 0xFF, cpu.X);
}

TEST_F(MOS6502_ROLFixture, ROL_ABSX_CanAffectZeroFlag) {
    cpu.Status.C = 0;
    cpu.X = 0x05;
    ROL_ABS_CanRollLeft(MOS6502_OpCodes::ROL_ABSX, 0x80, cpu.X);
    EXPECT_TRUE(cpu.Status.Z);
}
