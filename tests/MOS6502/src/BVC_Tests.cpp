...
TEST_F(MOS6502_BVCFixture, BVC_REL_CanBranch) {
    B_REL_CanBranch(MOS6502_OpCodes::BVC_REL, MOS6502_Status_V, false);
}

TEST_F(MOS6502_BVCFixture, BVC_REL_CannotBranch) {
    B_REL_CannotBranch(MOS6502_OpCodes::BVC_REL, MOS6502_Status_V, true);
}

TEST_F(MOS6502_BVCFixture, BVC_REL_CanBranch_WithPageCrossing) {
    B_REL_CanBranch_WithPageCrossing(MOS6502_OpCodes::BVC_REL, MOS6502_Status_V, false);
}
