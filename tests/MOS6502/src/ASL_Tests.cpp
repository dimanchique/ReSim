...
public:
    ...
    void ASL_ZPX_CanDoShiftLeft(BYTE value) {
        ...
        // then:
        EXPECT_EQ(mem[(0x42 + cpu.X) & 0xFF], BYTE(value << 1));
        CheckCyclesCount();
    }

    void ASL_ABS_CanDoShiftLeft(BYTE value) {
        // given:
        mem[effectiveAddress++] = ASL_ABS;
    ...
    void ASL_ABS_CanDoShiftLeft(MOS6502_OpCodes_Main opcode, BYTE value, BYTE affectingRegister) {
        // given:
