...
class MOS6502_CPUFixture : public MOS6502_TestFixture {};

TEST_F(MOS6502_CPUFixture, CpuDoesNothingWithZeroCycles) {
    // given:
    cyclesExpected = 0;
...
TEST_F(MOS6502_CPUFixture, CpuCanExecuteMoreCyclesThenRequested) {
    // given:
    mem[0xFFFC] = MOS6502_OpCodes::JSR_ABS;     // This instruction takes 6 cycles
    mem[0xFFFD] = 0x42;
    mem[0xFFFE] = 0x42;
