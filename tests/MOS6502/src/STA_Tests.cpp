...
TEST_F(MOS6502_STAFixture, STA_INDX_CanStoreValue) {
    ...
    mem[effectiveAddress++] = STA_INDX;     // read the 8 bit value from the next mem cell and add X
...
TEST_F(MOS6502_STAFixture, STA_INDY_CanStoreValue) {
    ...
    mem[effectiveAddress++] = STA_INDY;         // read the 8 bit value from the next mem cell
