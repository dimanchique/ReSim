...
TEST_F(MOS6502_EORFixture, EOR_INDX_CanDoExclusiveOR) {
    ...
    mem[effectiveAddress++] = EOR_INDX;         // read the 8 bit value from the next mem cell and add X
...
TEST_F(MOS6502_EORFixture, EOR_INDY_CanDoExclusiveOR) {
    ...
    mem[effectiveAddress++] = EOR_INDY;         // read the 8 bit value from the next mem cell
