...
void MOS6502_INCFixture::INC_ZP_CanAffectValue(MOS6502_OpCodes_Main opcode, BYTE memoryValue, BYTE offsetValueRegister) {
    // given:
...
void MOS6502_INCFixture::INC_ABS_CanAffectValue(MOS6502_OpCodes_Main opcode, BYTE memoryValue, BYTE offsetValueRegister) {
    // given:
    BYTE targetValue = memoryValue + 1;
...
void MOS6502_INCFixture::INC_IMPL_CanAffectValue(MOS6502_OpCodes_Main opcode, BYTE &targetRegister) {
    // given:
