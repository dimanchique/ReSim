...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, ROR_1_BX_Addressed_Mem) {
    ...
    TestMemoryInstruction(memAddress, memValue, GRP2_Eb_1, modReg, GRP2_ROR, 16);
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, ROR_1_BH_Reg) {
    ...
    TestRegisterInstruction(&cpu.BH, refValue, GRP2_Eb_1, &reg, GRP2_ROR, 16);
    EXPECT_EQ(cpu.Status.C, 1);
    EXPECT_EQ(cpu.Status.O, 1);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, ROR_1_AH_Reg) {
    ...
    TestRegisterInstruction(&cpu.AH, refValue, GRP2_Eb_1, &reg, GRP2_ROR, 16);
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, ROR_CL_AX_Reg) {
    ...
    TestRegisterInstruction(&cpu.AX, refValue, GRP2_Ev_CL, &reg, GRP2_ROR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, RCR_1_AL_Reg) {
    ...
    TestRegisterInstruction(&cpu.AL, refValue, GRP2_Eb_1, &reg, GRP2_RCR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 1);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, RCR_1_BH_Reg) {
    ...
    TestRegisterInstruction(&cpu.BH, refValue, GRP2_Eb_1, &reg, GRP2_RCR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, RCR_CL_DX_Reg) {
    ...
    TestRegisterInstruction(&cpu.DX, refValue, GRP2_Ev_CL, &reg, GRP2_RCR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SHR_1_BL_Reg) {
    ...
    TestRegisterInstruction(&cpu.BL, refValue, GRP2_Eb_1, &reg, GRP2_SHR, 16);
    EXPECT_EQ(cpu.Status.C, 1);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SHR_1_CL_Reg) {
    ...
    TestRegisterInstruction(&cpu.CL, refValue, GRP2_Eb_1, &reg, GRP2_SHR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SHR_CL_AX_Reg) {
    ...
    TestRegisterInstruction(&cpu.AX, refValue, GRP2_Ev_CL, &reg, GRP2_SHR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SAR_1_BL_Reg) {
    ...
    TestRegisterInstruction(&cpu.BL, refValue, GRP2_Eb_1, &reg, GRP2_SAR, 16);
    EXPECT_EQ(cpu.Status.C, 1);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SAR_1_CL_Reg) {
    ...
    TestRegisterInstruction(&cpu.CL, refValue, GRP2_Eb_1, &reg, GRP2_SAR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
...
TEST_F(I8086_ROR_RCR_SAR_SHR_Fixture, SAR_CL_AX_Reg) {
    ...
    TestRegisterInstruction(&cpu.AX, refValue, GRP2_Ev_CL, &reg, GRP2_SAR, 16);
    EXPECT_EQ(cpu.Status.C, 0);
    EXPECT_EQ(cpu.Status.O, 0);
}
