...
TEST_F(I8086_AND_Fixture, AND_Ev_Gv_Direct_Addressed_BX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_AND_Fixture, AND_Ev_Gv_BP_Addressed_WithDisp_DX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_AND_Fixture, AND_Ev_Gv_BXSI_Addressed_WithDisp_AX) {
    ModRegByteConstructor modReg;
...
TEST_F(I8086_AND_IM_Fixture, AND_AL_Ib_Test1) {
    TestAccumulatorWithImmediateData<BYTE>(0x11, 0x22, AND_AL_Ib, 4);
    EXPECT_EQ(cpu.AL, 0x11 & 0x22);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Ib_Test2) {
    TestAccumulatorWithImmediateData<BYTE>(0x10, 0x01, AND_AL_Ib, 4);
    EXPECT_EQ(cpu.AL, 0x10 & 0x01);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Ib_Test3) {
    TestAccumulatorWithImmediateData<BYTE>(0x00, 0x00, AND_AL_Ib, 4);
    EXPECT_EQ(cpu.AL, 0x00);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Ib_Test4) {
    TestAccumulatorWithImmediateData<BYTE>(0xFF, 0xFF, AND_AL_Ib, 4);
    EXPECT_EQ(cpu.AL, 0xFF);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Ib_Test5) {
    TestAccumulatorWithImmediateData<BYTE>(0xFF, 0x00, AND_AL_Ib, 4);
    EXPECT_EQ(cpu.AL, 0x00);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Iv_Test1) {
    TestAccumulatorWithImmediateData<WORD>(0x1111, 0x2222, AND_AX_Iv, 4);
    EXPECT_EQ(cpu.AX, 0x1111 & 0x2222);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Iv_Test2) {
    TestAccumulatorWithImmediateData<WORD>(0x1010, 0x0101, AND_AX_Iv, 4);
    EXPECT_EQ(cpu.AX, 0x0000);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Iv_Test3) {
    TestAccumulatorWithImmediateData<WORD>(0x0000, 0x0000, AND_AX_Iv, 4);
    EXPECT_EQ(cpu.AX, 0x0000);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Iv_Test4) {
    TestAccumulatorWithImmediateData<WORD>(0xFFFF, 0xFFFF, AND_AX_Iv, 4);
    EXPECT_EQ(cpu.AX, 0xFFFF);
}

TEST_F(I8086_AND_IM_Fixture, AND_AL_Iv_Test5) {
    TestAccumulatorWithImmediateData<WORD>(0xFFFF, 0x0000, AND_AX_Iv, 4);
    EXPECT_EQ(cpu.AX, 0x0000);
}
