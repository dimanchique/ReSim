...
public:
    void ORA_IM_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::ORA_IM;
    ...
    void ORA_ZP_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::ORA_ZP;
        mem[0xFFFD] = 0x42;
    ...
    void ORA_ZPX_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        ...
        cpu.A = initialValue;
        cpu.X = 0x10;
        mem[0xFFFC] = CPU6502_OpCodes::ORA_ZPX;
        mem[0xFFFD] = 0x42;
    ...
    void ORA_ABS_CanLoadValue(BYTE initialValue, BYTE memoryValue) {
        // given:
        cpu.A = initialValue;
        mem[0xFFFC] = CPU6502_OpCodes::ORA_ABS;
        mem[0xFFFD] = 0x80;
        mem[0xFFFE] = 0x44;
...
TEST_F(CPU6502_ORAFixture, ORA_INDY_CanLoadValue_WithExtraCycleOnPageCrossing) {
    // given:
    cpu.A = 0x42;
