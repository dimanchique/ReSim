...
TEST_F(I8080_SBBFixture, SBB_A_1) {
    SBB_A_CanSBBAccumulator(0x01, 0x00,
                            I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0}, 0);
}

TEST_F(I8080_SBBFixture, SBB_A_2) {
    SBB_A_CanSBBAccumulator(0x01, 0xFF,
                            I8080_Status{.C = 1, .P = 1, .AC = 1, .Z = 0, .S = 1}, 1);
}

TEST_F(I8080_SBBFixture, SBB_A_3) {
    SBB_A_CanSBBAccumulator(0xAD, 0xFF,
                            I8080_Status{.C = 1, .P = 1, .AC = 1, .Z = 0, .S = 1}, 1);
}

TEST_F(I8080_SBBFixture, SBB_A_4) {
    SBB_A_CanSBBAccumulator(0x00, 0x00,
                            I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0}, 0);
}

TEST_F(I8080_SBBFixture, SBB_B_1) {
    cpu.B = 0x05;
    SBB_Register_CanSBBRegisterToAccumulator(SBB_B, 0x20, 0, 0x1B,
                                             I8080_Status{.C = 0, .P = 1, .AC = 1, .Z = 0, .S = 0});
}

TEST_F(I8080_SBBFixture, SBB_B_2) {
    cpu.B = 0x20;
    SBB_Register_CanSBBRegisterToAccumulator(SBB_B, 0x10, 1, -0x11,
...
TEST_F(I8080_SBBFixture, SBB_B_3) {
    ...
    SBB_Register_CanSBBRegisterToAccumulator(SBB_B, 0b00111101, 1, 0b11111010,
                                             I8080_Status{.C = 1, .P = 1, .AC = 0, .Z = 0, .S = 1});
}
