...
TEST_F(I8080_MOVFixture, ExecuteMOV_MA) {
    cpu.A = 0x23;
    RegToMemMov(I8080_OpCodes::MOV_M_A, 0x1234, 0x23);
}

TEST_F(I8080_MOVFixture, ExecuteMOV_MB) {
    cpu.B = 0x23;
    RegToMemMov(I8080_OpCodes::MOV_M_B, 0x1234, 0x23);
}

TEST_F(I8080_MOVFixture, ExecuteMOV_MC) {
    cpu.C = 0x23;
    RegToMemMov(I8080_OpCodes::MOV_M_C, 0x1234, 0x23);
}

TEST_F(I8080_MOVFixture, ExecuteMOV_MD) {
    cpu.D = 0x23;
    RegToMemMov(I8080_OpCodes::MOV_M_D, 0x1234, 0x23);
}

TEST_F(I8080_MOVFixture, ExecuteMOV_ME) {
    cpu.E = 0x23;
    RegToMemMov(I8080_OpCodes::MOV_M_E,  0x1234, 0x23);
}
