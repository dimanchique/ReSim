...
TEST_F(I8080_SUBFixture, SUB_A_5) {
    SUB_A_CanZeroAccumulator(0x48, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_6) {
    SUB_A_CanZeroAccumulator(0x88, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}
...
TEST_F(I8080_SUBFixture, SUB_B_5) {
    ...
    SUB_Register_CanSubtractRegisterFromAccumulator(SUB_B, 0xCA, 0x14,
                                                    I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 0, .S = 0});
}
