...
TEST_F(I8080_SUBFixture, SUB_A_1) {
    SUB_A_CanZeroAccumulator(0x00, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_2) {
    SUB_A_CanZeroAccumulator(0x04, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_3) {
    SUB_A_CanZeroAccumulator(0x10, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_4) {
    SUB_A_CanZeroAccumulator(0x40, I8080_Status{.C = 0, .P = 1, .AC = 0, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_5) {
    SUB_A_CanZeroAccumulator(0x48, I8080_Status{.C = 0, .P = 1, .AC = 1, .Z = 1, .S = 0});
}

TEST_F(I8080_SUBFixture, SUB_A_6) {
    SUB_A_CanZeroAccumulator(0x88, I8080_Status{.C = 0, .P = 1, .AC = 1, .Z = 1, .S = 0});
}
...
TEST_F(I8080_SUBFixture, SUB_B_2) {
    ...
    SUB_Register_CanSubtractRegisterFromAccumulator(SUB_B, 0xC5, 0x27,
                                                    I8080_Status{.C = 0, .P = 1, .AC = 1, .Z = 0, .S = 0});
}
...
TEST_F(I8080_SUBFixture, SUB_B_4) {
    ...
    SUB_Register_CanSubtractRegisterFromAccumulator(SUB_B, 0xDA, 0x00,
                                                    I8080_Status{.C = 0, .P = 1, .AC = 1, .Z = 1, .S = 0});
}
...
TEST_F(I8080_SUBFixture, SUB_B_6) {
    ...
    SUB_Register_CanSubtractRegisterFromAccumulator(SUB_B, 0xDD, 0xE3,
                                                    I8080_Status{.C = 1, .P = 0, .AC = 1, .Z = 0, .S = 1});
}
