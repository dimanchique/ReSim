...
public:
    ...
    void ADD_Register_CanAddRegisterToAccumulator(const I8080_OpCodes_Main opcode,
        ...
        cpu.A = initialValue;
        mem[0x0000] = opcode;
        mem[opcode == ADI ? 0x0002 : 0x0001] = I8080_STOP_OPCODE;
...
TEST_F(I8080_ADDFixture, ADD_M_2) {
    ADD_CanAddMemoryToAccumulator(0b11000101, 0b10011110, 0b01100011,
                                  I8080_Status{.C = 1, .P = 1, .AC = 1, .Z = 0, .S = 0});
}
