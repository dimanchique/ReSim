 ...
 */
FORCE_INLINE void CPU6502_ST_ZP(Memory &memory, CPU6502 &cpu, BYTE &targetRegister) {
 ...
 */
FORCE_INLINE void CPU6502_ST_ZP(Memory &memory, CPU6502 &cpu, BYTE &targetRegister, BYTE affectingRegister) {
 ...
 * @param targetRegister Register to store.
 */
FORCE_INLINE void CPU6502_ST_ABS(Memory &memory, CPU6502 &cpu, BYTE &targetRegister) {
 ...
 * @param affectingRegister Address offset register.
 */
FORCE_INLINE void CPU6502_ST_ABS(Memory &memory, CPU6502 &cpu, BYTE &targetRegister, BYTE affectingRegister) {
