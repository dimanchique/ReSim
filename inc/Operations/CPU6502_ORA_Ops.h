 ...
 */
FORCE_INLINE void GenericORA(CPU6502 &cpu, const BYTE value) {
    cpu.A |= value;
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_IM(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_ZP(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_ZPX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_ABS(Memory &memory, CPU6502 &cpu) {
 ...
 */
FORCE_INLINE void CPU6502_ORA_ABS(Memory &memory, CPU6502 &cpu, BYTE affectingRegister) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_ABSX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_ABSY(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_INDX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ORA_INDY(Memory &memory, CPU6502 &cpu) {
