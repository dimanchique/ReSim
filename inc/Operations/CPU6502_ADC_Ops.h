 ...
 */
FORCE_INLINE void GenericADC(CPU6502 &cpu, const BYTE value) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_IM(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_ZP(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_ZPX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_ABS(Memory &memory, CPU6502 &cpu) {
 ...
 */
FORCE_INLINE void CPU6502_ADC_ABS(Memory &memory, CPU6502 &cpu, BYTE affectingRegister) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_ABSX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_ABSY(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_INDX(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_ADC_INDY(Memory &memory, CPU6502 &cpu) {
