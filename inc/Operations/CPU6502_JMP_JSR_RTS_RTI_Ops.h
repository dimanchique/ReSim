 ...
 */
inline void CPU6502_JMP_ABS(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_JMP_IND(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_JSR_ABS(Memory &memory, CPU6502 &cpu) {
    const WORD TargetAddress = cpu.FetchWord(memory);
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_RTS_IMPL(Memory &memory, CPU6502 &cpu) {
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_BRK_IMPL(Memory &memory, CPU6502 &cpu) {
    cpu.PushProgramCounterToStack(memory);
 ...
 * @param cpu CPU6502 struct instance.
 */
inline void CPU6502_RTI_IMPL(Memory &memory, CPU6502 &cpu) {
