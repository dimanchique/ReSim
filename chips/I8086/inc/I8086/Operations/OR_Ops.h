...
template<typename T>
FORCE_INLINE void I8086_OR_Ex_Gx(Memory &memory, I8086 &cpu) {
...
template<typename T>
FORCE_INLINE void I8086_OR_Gx_Ex(Memory &memory, I8086 &cpu) {
    const OperandSize opSize = std::is_same_v<T, BYTE> ? OperandSize::BYTE : OperandSize::WORD;
...
template<typename T>
FORCE_INLINE void I8086_OR_Ex_Ix(Memory &memory, I8086 &cpu, const ModRegByte modRegByte) {
    const OperandSize opSize = std::is_same_v<T, BYTE> ? OperandSize::BYTE : OperandSize::WORD;
